...
namespace Kasp.CloudMessage.FireBase.Data {
	public class FcmUserTokenRepository<TDbContext> : EFBaseRepository<TDbContext, FcmUserToken>, IFcmUserTokenRepository where TDbContext : DbContext, IFcmDbContext {
